...
directive('horizontalMenu', function(){
	...
	directive('sidebarMenur', function(){
		return {
			restrict: 'E',
			templateUrl: appHelper.templatePath('layoutRec/sidebar-menu'),
			controller: 'SidebarMenuCtrlr'
		};
	}).

	directive('sidebarMenuc', function(){
		return {
			restrict: 'E',
			templateUrl: appHelper.templatePath('layoutCand/sidebar-menu'),
			controller: 'SidebarMenuCtrlc'
		};
	}).
	...
	directive('sidebarProfiler', function(){
		return {
			restrict: 'E',
			replace: true,
			templateUrl: appHelper.templatePath('layoutRec/sidebar-profile')
		};
	}).

	directive('sidebarProfilec', function(){
		return {
			restrict: 'E',
			replace: true,
			templateUrl: appHelper.templatePath('layoutCand/sidebar-profile')
		};
	}).
		...
		return {
			link: function (scope, element, attrs) {
				...
				scope.confirmClick = function(msg) {
					...
					msg = msg || attrs.confirmClick || 'Vous voulez vraiment supprimer ce recruteur ?';
